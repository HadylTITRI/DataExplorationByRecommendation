...
def collect_data(n_clicks, selected_site_text):
    if n_clicks and selected_site_text:
        ...
        if error:
            return 0, "danger", 0, "danger", 0, "danger", [html.Div(f"Error during data collection: {error}", style={'color': 'red'})]
        ...
        if error:
            return 100, "success", 0, "danger", 0, "danger", [html.Div(f"Error during data preprocessing: {error}", style={'color': 'red'})]
        ...
        if error:
            return 100, "success", 100, "success", 0, "danger", [html.Div(f"Error during clustering: {error}", style={'color': 'red'})]
